...
const PortfolioProjects = () => {
  ...
  const PortfolioContent = [
    ...
    },
    {
      ...
      cat: "craft",
      description:
      <p className="project-description">A custom-built rackmount PC for running a host of virtual instruments and effects with complex audio routing and processing in a live performance setting. Parts list:
    ...
    },
    {
      ...
      cat: "craft",
      description:
      <p className="project-description">Built several acoustic panels of varying densities in order to turn a spare room in my house into a suitable recording and mixing environment. I conducted numerous acoustic measurements over the course of several weeks using Room EQ Wizard and a calibrated omnidirectional microphone in order to identify secondary reflection points, room modes, frequency decay, and aim for overall flatness of a sine sweep from 20Hz to 20kHz. Using the data from Room EQ Wizard and careful placement of panels, and consistent experimentation, I was able to identify the ideal monitor placement and set up the room to be within 6 decibels of a completely flat response from the listening position (comparable to professional level recording and engineering studios). Starting measurements before treatment showed a range of over 50 decibels of variance.</p>,
      technology: ["JavaScript", "HTML", "CSS"],
    },
    {
    ...
    },
    {
      ...
      cat: "craft",
      description:
      <p className="project-description">A stained glass box shelf made from wood, clear acrylic, shattered pieces of colored glass, and led string lights. LEDs sandwiched between panes of acrylic and colored glass pieces in the top and sides of the box shelf, causing a colorful light effect emanating from the shelf when turned on, similar to prismatic light refraction. </p>,
    ...
    },
    {
      ...
      cat: "music",
      description:
        <p className="project-description">Music released with my Atlanta-based band Jack and the Other. Catalog encompasses 19 songs over three EPs and two standalone singles, and has received over two million cross-platform streams to date.</p>,
      technology: [],
    },
    {
      ...
      cat: "music",
      description:
      <p className="project-description">Custom audio visualizer for my band's song 'I Need It'. Utilized displacement mapping and parallax animation to create 3-dimensional depth and movement effects from a still image source. </p>,
      technology: ["JavaScript", "HTML", "CSS"],
    },
    {
      ...
      cat: "video",
      description:
      <p className="project-description">Claymation music video for my band's song 'Passin Through'. Contributed concept, set design, story-boarding, logistics, lighting, and minor VFX with Adobe After Effects.</p>,
      technology: ["JavaScript", "HTML", "CSS"],
    },
    {
      ...
      cat: "video",
      description:
      <p className="project-description">Video editing and FX for my band's song 'Flare'. In addition to stylistic visual effects, raw footage encoding, and general editing, I relied heavily upon object tracking, stabilization, rotoscoping, AI content fill, and Twixtor's frame interpolation algorithm. Majority of editing was done in Premiere, with certain VFX and footage preparation completed in Adobe After Effects.</p>,
      technology: ["JavaScript", "HTML", "CSS"],
    },
    {
      ...
      cat: "coding",
      description:
        <p className="project-description">A custom Google Chrome extension used by three separate teams for prospecting, information gathering, and lead generation. The extension parses the text of online news articles currently being viewed in the user's browser window, identifies significant information contained therein, and organizes the information into various categories. Allows users to quickly and easily extract relevant information from the article at hand without having to read the entire article.</p>,
      technology: ["JavaScript", "HTML", "CSS"],
    },
    {
      title: "Band website",
      ...
      cat: "coding",
      description:
        <p className="project-description">A fully-responsive React-based website for my band Jack and the Other to share information, music, videos, merchandise, and updates with our fans and followers.</p>,
    ...
    },
    {
      ...
      cat: "coding",
      description:
        <p className="project-description">Two players, one mouse. A non-existent twist on a beloved a classic.</p>,
      technology: ["JavaScript", "HTML", "CSS"],
    },
    {
      ...
      cat: "coding",
      description:
        <p className="project-description">A website to showcase my personal projects with my personal network and potential employers. Designed all non-photograph visual assets and images. **INSERT LINK** READ MORE HERE **INSERT LINK**</p>,
